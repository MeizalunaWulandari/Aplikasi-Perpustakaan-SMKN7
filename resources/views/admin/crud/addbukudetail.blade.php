...
@section('content')
    ...
    <div class="page-body">
        <form action="{{ url('admin/simpan-detail-buku') }}" method="POST">
            @csrf
            <input type="hidden" name="id" value="{{ $buku->id }}">
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Judul Buku</label>
                <input type="text" class="form-control @error('judul') is-invalid @enderror"
                    id="exampleFormControlInput1" placeholder="Judul Buku" name="judul"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('jenis_buku') is-invalid @enderror"
                    id="exampleFormControlInput1" placeholder="Jenis Buku" name="jenis_buku"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kategori_buku') is-invalid @enderror"
                    id="exampleFormControlInput1" placeholder="Kategori Buku" name="kategori_buku"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('no_induk') is-invalid @enderror"
                    id="exampleFormControlInput1" placeholder=".../SMKN7/H.2021" name="no_induk" required autofocus>
                @error('no_induk')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('isbn') is-invalid @enderror" id="exampleFormControlInput1"
                    placeholder="ISBN (International Standard Book Number)" name="isbn">
                @error('isbn')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
