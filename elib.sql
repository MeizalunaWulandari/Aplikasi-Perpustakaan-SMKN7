...
CREATE TABLE IF NOT EXISTS `tbelib_buku` (
  ...
  `penerbit` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
...
REPLACE INTO `tbelib_buku` (`id`, `cover`, `judul`, `slug`, `pengarang`, `singkatan_pengarang`, `tempat_terbit`, `penerbit`, `tahun_terbit`, `no_klasifikasi`, `tahun_buku`, `inisial_buku`, `file_pdf`, `quantity`, `stock`, `jenis_id`, `kategori_id`) VALUES
	(12, 'book-cover/bdmNA3iLNpOCXfdF4VuoCH9y2Iu8IOv77JTBQvGI.png', 'Cerdas Cergas Berbahasa dan Bersastra Indonesia', 'cerdas-cergas-berbahasa-dan-bersastra-indonesia', 'Henny Marwati', 'H', 'Jakarta', 'Kementrian Pendidikan, Kebudayaan, Riset dan Teknologi', '2021', '337', '2021', 'C', 'bahasa-indonesia-bs-kls-xi-pdf.pdf', 0, 0, 2, 1),
	(13, 'book-cover/9ozFN9TGqW8vZ9fGZEaIr2o1Yt1YsBm6uMIFk66T.png', 'Bahasa Indonesia', 'bahasa-indonesia', 'Suherli, Maman Suryaman, Aji Septiaji, Istiqomah', 'S', 'Jakarta', 'Pusat Kurikulum dan Perbukuan, Balitbang, Kemendikbud', '2017', NULL, '2017', 'B', NULL, 0, 0, 1, 2);
...
REPLACE INTO `tbelib_buku_detail` (`id`, `no_induk`, `isbn`, `status`, `buku_id`) VALUES
	(1, '001/SMKN7/H.2017', '978-602-282-101-4', 1, 13);
